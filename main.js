...
const imgAprovado = '<img src="./images/aprovado.png" alt="Imagem de verificado"/>';
const imgReprovado = '<img src="./images/reprovado.png" alt="Imagem de X"/>';
const atividades = [];
const notas = [];
...
function adicionaLinha() {
    ...
    if(atividades.includes(inputNomeAtividade.value)) {
        alert(`A nota da atividade de ${inputNomeAtividade.value} já foi inserida.`)
    } else {
